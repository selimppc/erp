<div class="form" >
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'user_type',array('Admin'=>'Admin', 'General Ledger'=>'General Ledger', 'GL and Inventory'=>'GL and Inventory', 'Inventory'=>'Inventory', 'Purchase'=>'Purchase', 'Purchase and Inventory'=>'Purchase and Inventory', 'Sales'=>'Sales', 'Sales and Inventory'=>'Sales and Inventory'), array('empty'=>'- Select user type -', 'required'=>TRUE )); ?>
