...
<table style="text-align: left; ">
	  ...
	  <tr>
	  	...
	  	<td>
	  	<?php echo CHtml::activeDropDownList($model, 'cm_group', CHtml::listData(Codesparam::model()->findAll('cm_type="Product Group"'), 'cm_code', 'cm_desc'),array('empty'=>'- Select Product Group -')); ?>
        </td>
