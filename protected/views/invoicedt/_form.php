...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'sm_unit',array('id'=>'unit_a', 'required'=>TRUE,)); ?>
        <?php echo $form->error($model,'sm_unit'); ?>
    </div>

	<div class="row">
		<?php echo $form->labelEx($model,'sm_unit_qty'); ?>
		<?php echo $form->textField($model,'sm_unit_qty',array('id'=>'unit_qty', 'required'=>TRUE,)); ?>
		<?php echo $form->error($model,'sm_unit_qty'); ?>
	</div>

	<div class="row">
		<label>Order Quantity</label>
		<?php echo $form->textField($model,'sm_quantity',array('required'=>TRUE)); ?>
