...
<div style="width: 98%; float: left;">
    ...
    <div style="width: 51%; float: left; ">
        ...
        <div style="width: 99%; float: left; text-align: center;">
            ...
            <?php echo CHtml::link('POST to GL', array('PostToGlAp', 'am_vouchernumber'=>$am_vouchernumber), array('class'=>'btn_btn', 'style'=>'height: 21px; text-align: center; width: 143px; box-shadow: 10px 3px 5px #aaa; ')); ?>
