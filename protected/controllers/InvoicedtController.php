...
class InvoicedtController extends Controller
{
    ...
    public function actionAutocompleteTestNew() {
        ...
        if (!empty($_GET['term'])) {
            ...
            $sql = "SELECT t.cm_name as label, t.cm_code as code, t.cm_sellrate as rate,t.cm_selltax as tax, t.cm_stkunit as unit, t.cm_sellunit as sellunit, t.cm_sellconfact as unit_qty, r.cm_code, SUM(available) as available
