	...
	<div class="row buttons">
		<div class="row status-container">
          <div class="span4 action-bar">
				<?php echo CHtml::submitButton($model->isNewRecord ? 'Save' : 'Save', array('class'=>'action-btn', 'id'=>'action-btn-1', 'name' => 'submit', 'style'=>'margin-right: 10px;')); ?>
...
<h1>List Group Two</h1>
	
		<?php $this->widget('zii.widgets.grid.CGridView', array(
			'id'=>'grouptwo-grid',
			'dataProvider'=>Grouptwo::model()->search(),
			//'filter'=>$model,
			'columns'=>array(
				//'id',
				'am_groupone',
