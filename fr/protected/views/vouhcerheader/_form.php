...
<table>
	...
	<tr>
		...
		<td> <?php echo $form->textField($model,'am_vouchernumber', array('id'=>'am_vouchernumber', 'style'=>'width: 140px;', 'readonly'=>'readonly') ); ?> <?php echo $form->error($model,'am_vouchernumber'); ?></td>
		<td> Date </td>
		<td colspan="2"> 
...
<table>	
	...
	<tbody>
		<tr>
			...
			<td width="200"> <input id="account_desc" style="width: 200px; padding: 3px;" readonly="readonly"/> </td>
...
<table style="width: 34%; float: left; margin-left: 46%;">
	<tr>
		...
		<td width="120"> <?php echo $form->textField($model,'am_referance', array('value'=>'0', 'id'=>'total_prime_amount', 'readonly'=>'readonly', 'style'=>'width: 120px; text-align: right')); ?> </td>
		<td width="120"> <?php echo $form->textField($model,'am_referance', array('value'=>'0', 'id'=>'total_base_amount', 'readonly'=>'readonly',  'style'=>'width: 120px; text-align: right')); ?> </td>
	</tr>
</table>
