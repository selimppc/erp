...
<div id="box_input_id">
	...
	<div id="part_20">
		...
		<?php 
			$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
				...
				'source'=>CController::createUrl('/Customermst/AutocompleteTest'),
				'options'=>array(
					'minLength'=>'1', 
					'select'=>'js:function(event, ui){
						$("#cm_acccode").text(ui.item.value);
						$("#account_description").val(ui.item.label);
					}'
				),
				'htmlOptions'=>array(
					'id'=>'cm_acccode',
	...
	<div id="part_20">
		...
		<input id="account_description" readonly/>
	</div>
</div>
    
<div id="box_input_id">
	<div id="part_20">
		<?php echo $form->labelEx($model,'cm_accdisc'); ?>
        <?php 
			$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
				'name'=>'cm_accdisc',
				'model'=>$model,
				'attribute'=>'cm_accdisc',
				'source'=>CController::createUrl('/Customermst/AutocompleteTest'),
				'options'=>array(
					'minLength'=>'1', 
					'select'=>'js:function(event, ui){
						$("#cm_accdisc").text(ui.item.value);
						$("#account_discount").val(ui.item.label);
					}'
				),
				'htmlOptions'=>array(
					'id'=>'cm_accdisc',
	...
	<div id="part_20">
		...
		<input id="account_discount" readonly/>
	</div>
	<div id="part_20">
       ...
       <?php 
			$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
				...
				'options'=>array(
					'minLength'=>'1', 
					'select'=>'js:function(event, ui){
						$("#cm_acctax").text(ui.item.value);
						$("#tax_ac").val(ui.item.label);
					}'
				),
				'htmlOptions'=>array(
					'id'=>'cm_acctax',
