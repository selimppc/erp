...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model,'cm_type', array('value'=>'Product Group', 'readonly' => 'true')); ?>
	...
	<div class="row">
        <?php echo $form->labelEx($model,'cm_purtax'); ?>
        <?php echo $form->textField($model,'cm_purtax'); ?>
        <?php echo $form->error($model,'cm_purtax'); ?>
    </div>
