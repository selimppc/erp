...
class Transferdt extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, im_transfernum, cm_code, im_unit, im_quantity, im_rate, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
			array('im_quantity','numerical', 'integerOnly'=>TRUE),
	...
	public function attributeLabels()
	{
		return array(
			...
			'cm_code' => 'Poduct Code',
			'im_unit' => 'Unite de transfert',
			'im_quantity' => 'Quantite de Transfert',
			'im_rate' => 'Taux',
