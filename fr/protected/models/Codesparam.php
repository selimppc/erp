...
class Codesparam extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cm_type, cm_code, cm_acccode, cm_acctax, cm_props, cm_long, cm_percent, cm_branch, insertuser, updateuser', 'length', 'max'=>50),
			array('cm_desc, cm_accdisc', 'length', 'max'=>150),
			array('inserttime, updatetime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('cm_type, cm_code, cm_desc,cm_accdisc, cm_acccode, cm_acctax, cm_props, cm_long, cm_percent, cm_branch, cm_active, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'cm_code' => 'Code',
			'cm_desc' => 'Description',
			'cm_accdisc' => 'Reduction A/C',
		
			'cm_purtax' => 'Achat Impot %',
			'cm_acccode' => 'Code de compte',
			'cm_acctax' => 'Impot A/C',
			'cm_branch' => 'Branche Code',
		
			'cm_props' => 'Propriete',
			'cm_long' => 'Type d\'Addition',
			'cm_percent' => 'Pourcentage',
	...
	public function search()
	{
		...
		$criteria->compare('cm_acccode',$this->cm_desc,true);
		$criteria->compare('cm_acctax',$this->cm_desc,true);
		$criteria->compare('cm_branch',$this->cm_desc,true);
