...
class Vwapayable extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('suppliername, conperson', 'length', 'max'=>100),
			array('payableamt', 'length', 'max'=>42),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('suppliercode, suppliername, accoutcode, conperson, payableamt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'accoutcode' => 'Code de compte',
			'conperson' => 'Personne a Contacter',
			'payableamt' => 'Montant a payer',
		);
	}
