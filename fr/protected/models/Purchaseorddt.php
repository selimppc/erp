...
class Purchaseorddt extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, pp_purordnum, cm_code, pp_quantity, pp_grnqty, pp_unit, pp_unitqty, pp_purchasrate, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
			array('pp_purchasrate', 'numerical', 'integerOnly'=>false),
	...
	public function attributeLabels()
	{
		return array(
			...
			'pp_quantity' => 'Bon de commande Quantite',
			'pp_grnqty' => 'Grande Quantite',
			'pp_unit' => 'Unite de mesure',
			'pp_unitqty' => 'Unite Quantite',
			'pp_purchasrate' => 'Tarif d\'achat',
