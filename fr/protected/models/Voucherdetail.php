...
class Voucherdetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, am_vouchernumber, am_accountcode, am_currency, am_exchagerate, am_primeamt, am_baseamt, am_branch, am_note, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'amAccountcode' => array(self::BELONGS_TO, 'Chartofaccounts', 'am_accountcode'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'am_vouchernumber' => 'Am Vouchernumber',
			'am_accountcode' => 'Am Accountcode',
			'am_currency' => 'Am Currency',
			'am_exchagerate' => 'Am Exchagerate',
			'am_primeamt' => 'Am Primeamt',
			'am_baseamt' => 'Am Baseamt',
			'am_branch' => 'Am Branch',
			'am_note' => 'Am Note',
