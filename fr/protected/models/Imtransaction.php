...
class Imtransaction extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, im_number, cm_code, im_storeid, im_BatchNumber, im_date, im_ExpireDate, im_quantity, im_sign, im_unit, im_rate, im_totalprice, im_RefNumber, im_RefRow, im_note, im_status, im_voucherno, cm_supplierid, im_currency, im_ExchangeRate, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'cm_code' => array(self::BELONGS_TO, 'cm_productmaster', 'cm_code'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'im_number' => 'Nombre Recevez',
			'cm_code' => 'Code de produit',
			'im_storeid' => 'Magasin Id',
			'im_BatchNumber' => 'Numero de lot',
			'im_date' => 'Date',
			'im_ExpireDate' => 'Date d\'expiration',
			'im_quantity' => 'Recevez Quantite',
			'im_sign' => 'Connexion',
			'im_unit' => 'Unite',
			'im_rate' => 'Taux',
			'im_totalprice' => ' Prix ​​total',
			'im_RefNumber' => ' Ref Nombre',
			'im_RefRow' => 'Ref Nombre',
			'im_note' => 'Remarque',
			'im_status' => 'Statut',
			'im_voucherno' => ' Voucherno',
			'cm_supplierid' => 'Supplierid',
			'im_currency' => 'Monnaie',
			'im_ExchangeRate' => 'Taux de change',
	...
	public function search()
	{
		...
		$criteria->select = 't.*, m.cm_name, n.cm_description';
		$criteria->join = 'INNER JOIN cm_productmaster m ON t.cm_code = m.cm_code';
		$criteria->join .= ' INNER JOIN cm_branchmaster n ON t.im_storeid = n.cm_branch';
