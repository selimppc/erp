...
class Smvwcusreceivable extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cm_code, cm_name, cm_group, cm_address, cm_cellnumber, sm_receivable', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'cm_code' => 'Le code client',
			'cm_name' => 'Nom du client',
			'cm_group' => 'Groupe',
			'cm_address' => 'Adresse',
			'cm_cellnumber' => 'Telephone',
			'sm_receivable' => 'Montant a recevoir',
		);
	}
