...
class Branchmaster extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cm_currency, cm_contacperson, cm_designation, insertuser, updateuser', 'length', 'max'=>50),
			array('cm_mailingaddress', 'length', 'max'=>250),
			array('inserttime, updatetime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('cm_branch, cm_description, cm_currency, cm_contacperson, cm_designation, cm_mailingaddress, cm_phone, cm_cell, cm_fax, active, inserttime, updatetime, insertuser, updateuser', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'cm_currency' => 'Monnaie',
			'cm_contacperson' => 'Personne a Contacter',
			'cm_designation' => 'Designation',
			'cm_mailingaddress' => 'Adresse Postale',
			'cm_phone' => 'Telephone',
			'cm_cell' => 'Cellule',
			'cm_fax' => 'Fax',
			'active' => 'Actif',
