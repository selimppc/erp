...
class Trndetail extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'trnnumber' => 'Numero de transaction',
			'empid' => 'Employe ID',
			'salarytype' => 'Type de salaires',
			'amount' => 'Montant',
			'percent' => 'Pour Cent',
			'timeofbasic' => 'Temps de base',
			'areaamt' => 'Zone Montant',
			'adjustment' => 'Adjustment',
			'othour' => 'Au fil du temps Heure',
			'daydeduction' => 'Deduction de la Journee',
