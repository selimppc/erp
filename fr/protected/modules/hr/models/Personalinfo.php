...
class Personalinfo extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'empid' => 'Employe ID',
			'empname' => 'Nom de l\'employe',
			'doj' => 'Date d\'adhésion',
			'doc' => 'Date de confirmation',
			'grade' => 'Position',
			'deptname' => 'Departement',
			'designation' => 'Designation',
			'bank' => 'Banque / argent dans la main',
			'acccode' => 'Banque A/C No',
			'currency' => 'Monnaie',
			'exchangerate' => 'Taux de change',
			'amount' => 'Salaire total ',
			'leaveplan' => 'Laissez plan',
			'dob' => 'Date de naissance',
			'gender' => 'Sexe',
			'present' => 'Adresse Actuelle',
			'parmanent' => 'Parmanent incline adresse',
			'cellno' => 'Cellule No',
			'phone' => 'Terrain de telephone',
			'email' => 'Email',
			'branch' => 'Branche',
			'status' => 'Statut',
